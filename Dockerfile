...
RUN apt-get update -y && \
        apt-get install -y curl libgl1 libglib2.0-0 python3.12 python3.12-distutils git && \
...
RUN curl -fsL -o /usr/local/lib/python3.12/dist-packages/gradio/frpc_linux_amd64_v0.2 https://cdn-media.huggingface.co/frpc-gradio-0.2/frpc_linux_amd64 && \
        chmod +x /usr/local/lib/python3.12/dist-packages/gradio/frpc_linux_amd64_v0.2
